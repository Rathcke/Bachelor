...
% TODO: There is still room for improvement, however, for instance we plan
%       to implement storage of $k$-mer frequency vectors together with the
%       centroids such that these can be reused in subsequent similarity
%       calculations.
%
%       Additionally, there can be made more checks for the possibility of
%       stopping a comparison early, if it is already known that it will fail.
