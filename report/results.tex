...
The data in figure \ref{fig:levenshtein_vs_kdist_performance} shows how many
...
\begin{figure}[H] % TODO: we need to state which dataset and the lengths of seqs
  \centering
  \begin{tabular}{ c | c }
  ...
  \label{fig:levenshtein_vs_kdist_performance}
\end{figure}
...
shown above in figure \ref{fig:levenshtein_vs_kdist_performance}, that is indeed
