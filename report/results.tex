...
to the length of the longer sequence.
...
used for the MDS, because the scatter plot easily becomes to densely populated
...
length. \\ So it shows that sorting by increasing length is always
preferrable, which will be applied in future tests.
