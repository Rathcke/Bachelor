...
and because the computation is too expensive for \num{380000} sequences. A set
of 400 sequences, consisting of 40 expected clusters with 10 sequences in each,
...
for the MDS calculated using Levenshtein. This provides even some more insigt
...
a little more overlap in the clusters, which might again be attributed to the
imperfektion of MDS.
